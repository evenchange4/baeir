...
const Train_End =   new Date("2012-12-10 12:59:59").getTime();
const Test_Start =  new Date("2012-12-10 12:00:00").getTime();
const Test_End =    new Date("2012-12-10 23:59:59").getTime();
